...
class User
  ...
  def self.create(email_address:, name:, password:)
    ...
    result = DatabaseConnection.query("INSERT INTO users (email_address, name, password) VALUES($1, $2, $3) RETURNING id, email_address, name;", [email_address, name, encrypted_password])
